...
@WebServlet(name = "ServletsearchallJob", value = "/ServletsearchallJob")
public class searchAllJob extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println(date);
        if(id==null ||id==""){
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/ServletlistallJobs");
